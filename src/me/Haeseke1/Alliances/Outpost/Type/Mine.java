...
public class Mine {
	...
	public Mine(String name, Location loc1, Location loc2, Alliance owner) {
	...
	public Mine(String name, World world, int xmin, int xmax, int zmin, int zmax, Alliance alli) {
		this.nameWithColorCodes = name;
		this.name = ChatColor.translateAlternateColorCodes('&', name);
		this.world = world;
		this.xmin = xmin;
	...
	public static ItemStack createItem(){
		...
		im.setDisplayName(ChatColor.GOLD + "Mine");
		i.setItemMeta(im);
		return i;
	}
