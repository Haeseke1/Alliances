...
public class Blacksmith {
	...
	public static List<Blacksmith> blacksmiths = new ArrayList<Blacksmith>();
	...
	public Blacksmith(String name, Location loc1, Location loc2, Alliance owner) {
		...
		blacksmiths.add(this);
	}
	
	public Blacksmith(String name, World world, int xmin, int xmax, int zmin, int zmax, Alliance alli) {
		this.name = name;
		this.world = world;
		this.xmin = xmin;
		this.xmax = xmax;
	...
	public static ItemStack createItem(){
		...
		im.setDisplayName(ChatColor.GOLD + "Blacksmith");
		i.setItemMeta(im);
		return i;
	}
