...
public class Magic_Tower {

	public static HashMap<ItemStack, Integer> rewards = new HashMap<ItemStack,Integer>();
	
	public static List<Magic_Tower> magic_towers = new ArrayList<Magic_Tower>();
	...
	public Magic_Tower(String name, Location loc1, Location loc2, Alliance owner) {
		...
		magic_towers.add(this);
	}
	
	public Magic_Tower(String name, World world, int xmin, int xmax, int zmin, int zmax, Alliance alli) {
		this.name = name;
		this.world = world;
		this.xmin = xmin;
		this.xmax = xmax;
	...
	public static ItemStack createItem(){
		...
		im.setDisplayName(ChatColor.GOLD + "Magic Tower");
		i.setItemMeta(im);
		return i;
	}
