...
public class Dock {
	...
	public Dock(String name, Location loc1, Location loc2, Alliance owner) {
		this.name = name;
		this.owner = owner;
	...
	public Dock(String name, World world, int xmin, int xmax, int zmin, int zmax, Alliance alli) {
		this.name = name;
		this.world = world;
		this.xmin = xmin;
		this.xmax = xmax;
	...
	public static ItemStack createItem(){
		...
		im.setDisplayName(ChatColor.GOLD + "Dock");
		i.setItemMeta(im);
		return i;
	}
