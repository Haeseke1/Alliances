...
public class EndermanLV3 extends EntityEnderman{

	
	public EndermanLV3(World world){
		super(world);
		try {
	...
	public boolean damageEntity(DamageSource damagesource, float f) {
		if(damagesource.getEntity() instanceof EntityLiving && new Random().nextInt(3) == 0){
	...
	public static Enderman spawn(Location location, String name){
		...
		final EndermanLV3 customEntity = new EndermanLV3(mcWorld);
