...
public class EndermanLV1 extends EntityEnderman{

	
	
	public EndermanLV1(World world){
		super(world);
		try {
	...
	public boolean damageEntity(DamageSource damagesource, float f) {
		if(damagesource.getEntity() instanceof EntityLiving && new Random().nextInt(5) == 0){
	...
	public static Enderman spawn(Location location, String name){
		...
		final EndermanLV1 customEntity = new EndermanLV1(mcWorld);
