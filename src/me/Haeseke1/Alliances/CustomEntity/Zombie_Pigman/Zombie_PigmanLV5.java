...
public class Zombie_PigmanLV5 extends EntityPigZombie{

	public List<Zombie> minions = new ArrayList<Zombie>();
	
	public Zombie_PigmanLV5(World world){
		super(world);
		try {
	...
	public static PigZombie spawn(Location location, String name){
		...
		final Zombie_PigmanLV5 customEntity = new Zombie_PigmanLV5(mcWorld);
