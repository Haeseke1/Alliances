...
public class BlazeLV5 extends EntityBlaze{

	
	public BlazeLV5(World world){
		super(world);
		try {
        ...
        this.goalSelector.a(4, new BlazeLV5.PathfinderGoalCustomBlazeFireball(this));
	}
	...
	protected void initAttributes(){
		...
		this.getAttributeInstance(GenericAttributes.d).setValue(1);
	...
	public static Blaze spawn(Location location, String name){
		...
		final BlazeLV5 customEntity = new BlazeLV5(mcWorld);
