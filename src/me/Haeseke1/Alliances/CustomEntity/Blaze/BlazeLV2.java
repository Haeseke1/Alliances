...
public class BlazeLV2 extends EntityBlaze{

	
	public BlazeLV2(World world){
		super(world);
		try {
        ...
        this.goalSelector.a(4, new BlazeLV2.PathfinderGoalCustomBlazeFireball(this));
	}
	...
	public static Blaze spawn(Location location, String name){
		...
		final BlazeLV2 customEntity = new BlazeLV2(mcWorld);
