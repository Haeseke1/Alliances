...
public class Wither_SkeletonLV2 extends EntitySkeleton{

	
	public Wither_SkeletonLV2(World world){
		super(world);
		try {
	...
	public void n(Entity entity) {
		if (this.getSkeletonType() == 1 && entity instanceof EntityLiving) {
			((EntityLiving) entity).addEffect(new MobEffect(MobEffectList.WITHER.id, 200,1));
		}
	}
	...
	public static Skeleton spawn(Location location, String name){
		...
		final Wither_SkeletonLV2 customEntity = new Wither_SkeletonLV2(mcWorld);
