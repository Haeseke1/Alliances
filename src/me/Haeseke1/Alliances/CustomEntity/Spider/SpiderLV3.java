...
public class SpiderLV3 extends EntitySpider{

	
	public SpiderLV3(World world){
		super(world);
		try {
	...
	public void n(Entity entity) {
		if (entity instanceof EntityLiving) {
			((EntityLiving) entity).addEffect(new MobEffect(MobEffectList.SLOWER_MOVEMENT.id, 200,1));
		}
	}
	...
	public static Spider spawn(Location location, String name){
		...
		final SpiderLV3 customEntity = new SpiderLV3(mcWorld);
