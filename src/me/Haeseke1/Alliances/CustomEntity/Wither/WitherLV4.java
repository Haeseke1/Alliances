...
public class WitherLV4 extends EntityWither{

	
	public WitherLV4(World world){
		super(world);
		try {
	...
	protected void initAttributes(){
		...
		this.getAttributeInstance(GenericAttributes.maxHealth).setValue(1500D);
	...
	public static Wither spawn(Location location, String name){
		...
		final WitherLV4 customEntity = new WitherLV4(mcWorld);
