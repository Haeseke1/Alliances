...
public class CreeperLV4 extends EntityCreeper{

	private int fuseTicks = 0;
	private int maxFuseTicks = 30;
	
	public CreeperLV4(World world){
		super(world);
		try {
	...
	protected void initAttributes(){
		...
		this.getAttributeInstance(GenericAttributes.d).setValue(0.750);
	...
	public static Creeper spawn(Location location, String name){
		...
		final CreeperLV4 customEntity = new CreeperLV4(mcWorld);
