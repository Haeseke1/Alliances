...
public class aScoreBoard {
	...
	public static void setAllianceScoreBoard(Player player){
		...
		obj.setDisplayName(ChatColor.GOLD + "===  " + ChatColor.GOLD + "" + ChatColor.BOLD + "Alliance" + ChatColor.GOLD + "  ===");
	       }
	...
	public static void setPlayerScoreBoard(Player player){
		...
		Alliance alli = AllianceManager.getAlliance(player);
		setScore(player,ChatColor.GREEN + "Alliance:",15,obj,ChatColor.GREEN,ChatColor.translateAlternateColorCodes('&', alli.getName()));
		aPlayer aplayer =  APlayerManager.getAPlayer(player);
		setScore(player, ChatColor.GREEN + "Wins:",12,obj,ChatColor.YELLOW,ChatColor.AQUA + "" + aplayer.getWins() + "W");
		setScore(player, ChatColor.GREEN + "Loses:",9,obj,ChatColor.DARK_PURPLE,ChatColor.AQUA + "" + aplayer.getLoses() + "L");
		setScore(player, ChatColor.GREEN + "Coins:",6,obj,ChatColor.LIGHT_PURPLE,ChatColor.AQUA + "" + Coins.getPlayerCoins(player) + " coins");
		return;
	}
	
	public static void setScore(Player player,String scorename,int score,Objective obj, ChatColor color, String value){
